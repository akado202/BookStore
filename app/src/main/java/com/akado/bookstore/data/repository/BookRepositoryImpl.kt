...
class BookRepositoryImpl @Inject constructor(
    ...
    override fun getSearchResult(query: String, page: Int): Single<List<BookItemDomainModel>> {
        return remote.getSearchResult(query, page)
            .map { it.map(BookItemDomainMapper::mapToModel) }
    }

    override fun getBookDetail(isbn13: String): Single<BookDetailDomainModel> {
